      ...
      >
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-4">
            {[
              { color: AMBER, label: "Lead with joy, not admin", desc: "The first thing you do is record a favorite memory" },
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Wills, trusts, account lists, insurance — organized, encrypted, and ready for your family exactly when they need them.",
                badge: null,
              },
              {
                icon: UserCheck,
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            {[
              ...
              { icon: Shield, color: AMBER, num: "03", title: "Handle the Logistics", desc: "Organize wills and the documents your family needs — all secure, private, and easy to find." },
            ].map((step, i) => (
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-14">
            {[
              { quote: "My father passed before he could tell my kids who he really was. I don't want my grandchildren to wonder the same thing about me.", name: "Sarah T.", location: "Austin, TX" },
              { quote: "I wrote a letter to my son for his wedding day. I have no idea if I'll be there. But now I know he'll hear my voice either way.", name: "Michael R.", location: "Portland, OR" },
              { quote: "I set it up for my mom as a gift. She started recording memories that same afternoon. We both cried.", name: "Eleanor J.", location: "Nashville, TN" },
            ].map((t, i) => (
      ...
      <section className="py-28 px-6 md:px-16" ref={(el) => { sectionsRef.current[4] = el; }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {[
              { name: "Free", price: "$0", period: "", desc: "Join Waitlist", features: ["3 future letters", "Basic memory prompts", "Document storage (1GB)"], color: SAGE },
