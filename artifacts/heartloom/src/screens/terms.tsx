...
import { Scale, Shield, Lock, BookOpen, ScrollText, ArrowRight, Users } from "lucide-react";
              ...
              <Section id="delivery-guarantees" title="II. Guaranteed Message Delivery" icon={Lock}>
                <div className="grid md:grid-cols-2 gap-5 sm:gap-6">
                  ...
                  <ArticleCard title="Verification of Passing">
                    For “Last Will” communications, Heartloom applies a compassionate verification system, requiring documentation or trusted advocate confirmation before the vault is unsealed.
                  </ArticleCard>
                </div>
              </Section>
